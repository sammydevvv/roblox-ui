...
do
        ...
        if (typeof(theme) == 'string') then
            ...
            elseif (theme == 'grape') then       -- purple
                ...
                theme = {
                    ...
                    Inset1 = Color3.fromRGB(0,0,0);
                    Inset2 = Color3.fromRGB(0,0,0);
                    Inset3 = Color3.fromRGB(0,0,0);
    ...
    if (typeof(theme) ~= 'table') then
        theme = {
            ...
            Window1 = Color3.fromRGB(20, 20, 25); -- window headers (the tool bar w/ title and min/max buttons)
            Window2 = Color3.fromRGB(20, 20, 25); -- window background
            Window3 = Color3.fromRGB(20, 20, 25); -- sidebar, section header, tooltip header
